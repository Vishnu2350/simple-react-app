...
export default function TeamCard({ team }) {
  ...
  return (
    <div
      data-aos="fade-up"
      className="team_card cursor-pointer bg-sky-300 h-[550px] rounded-lg overflow-hidden relative flex flex-col items-center justify-center"
    >
      ...
      <div className="description text-center grid gap-3 px-5">
        ...
        <div className="social text-xl flex justify-center gap-4 text-white">
          <a href={`"tel:${phone}`}>
            <i className="fa-sharp fa-solid fa-tty"></i>
          </a>
          <a href={`mailto:${email}`}>
