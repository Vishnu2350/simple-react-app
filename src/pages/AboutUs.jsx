...
export default function AboutUs() {
  return (
    <>    
    <Pagetitle>About us - Eventor</Pagetitle>
    ...
    <p className="text-2xl mb-10 leading-10">Welcome to Evento , where dreams meet reality and every birthday celebration becomes a memorable masterpiece! We are a dedicated team of passionate individuals who believe in the magic of birthdays. Our mission is to turn your special day into an extraordinary event filled with joy, laughter, and cherished memories.</p>

    <h3 className="OurMission text-2xl mb-3">Our Mission</h3>

    <p className="text-lg mb-10 leading-8">At Evento , we understand the importance of birthdays. It's not just a date on the calendar; it's a momentous occasion that deserves to be celebrated in style. Our mission is to relieve you of all the planning stress and make your birthday party a reflection of your personality and dreams. Whether you're planning a whimsical children's party or an elegant soirée for adults, we are here to transform your vision into reality.</p>    
